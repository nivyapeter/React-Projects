...
function Header() {
  ...
  return (
    ...
    <div>
      ...
      <div className="lg:fixed lg:top-[35px] bg-[#15009b]  leading-6 font-medium w-full  2xl:h-[10vh] h-[12vh] lg:h-[13vh] z-30">
        <div className="2xl:w-full w-[80%] lg:w-full max-w-[1080px] lg:max-w-[1264px] 2xl:max-w-full md:py-[30px] lg:px-[30px] xl:pt-[8px] text-left z-[99] m-auto relative">
            ...
            <div className="pl-[177px] pt-[35px] float-right lg:pl-0 lg:pt-6 xl:pt-4 2xl:pt-6">
              <Nav />
