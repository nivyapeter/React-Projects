  ...
  return (
    <div className="py-[50px] bg-white font-light text-[#000000] leading-7 ">
        <div className="py-[30px] max-w-[1080px] w-[80%] m-auto md:pt-[30px] md:pb-0 md:px-0 lg:flex lg:flex-row lg:gap-8">
            ...
            <iframe className="w-[80vw] h-[47vh] md:h-[57vh] lg:h-[37vh] lg:w-[40vw] 2xl:w-[29vw] 2xl:h-[54vh]" src="https://player.vimeo.com/video/588343509?h=b7e59c30e6"height="450"></iframe>
            </div>
            <div>
